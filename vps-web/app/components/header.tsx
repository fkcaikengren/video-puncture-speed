...
export function Header() {
  ...
  return (
    <header className="flex h-16 shrink-0 items-center gap-2 border-b pr-4 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
